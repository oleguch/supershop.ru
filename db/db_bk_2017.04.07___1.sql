...
12	Теннисные ракетки	Ракетка — спортивный инвентарь, используемый в игровых видах спорта: теннисе (теннисная ракетка), сквоше, бадминтоне, настольном теннисе и некоторых других менее популярных играх, например, ракетболе
\.
...
COPY orders (id, email, name, phone, comment, city, street, house, app, delivery, id_user, "time") FROM stdin;
1	user@mail.ru	Вася	+7(912)912-12-12	\N	Москва	Победы	343	34	\N	19	2017-04-06 15:21:05.32088+03
\.
...
SELECT pg_catalog.setval('sold_goods_id_seq', 4, true);
