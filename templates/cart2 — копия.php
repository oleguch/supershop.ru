        ...
        <span class="head5">Итого</span>
           ...
           <?php
            foreach ($items as $item) {
                $cena = number_format($item['price'], 0, ',', ' ');
                echo "<div class='cart-line' id='cart-line$item[id]''>
                    ...
                    <span class='col4'>
                        <button class='cart-count-minus' onclick='minus($item[id])'>-</button><span id='count$item[id]' class='cart-item-count'>1</span><button class='cart-count-plus' onclick='plus($item[id])'>+</button>
                        </span>
                    <span class='col5'>
                        <span class='cart-item-sum' id='sum$item[id]'>$cena руб.</span>
